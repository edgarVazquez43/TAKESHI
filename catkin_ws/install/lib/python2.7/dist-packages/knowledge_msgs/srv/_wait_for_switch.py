...
"""autogenerated by genpy from knowledge_msgs/wait_for_switchRequest.msg. Do not edit."""
import sys
...
class wait_for_switchRequest(genpy.Message):
  _md5sum = "60d2194f0127ca2638d85f847c92c9e3"
  _type = "knowledge_msgs/wait_for_switchRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(wait_for_switchRequest, self).__init__(*args, **kwds)
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from knowledge_msgs/wait_for_switchResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class wait_for_switchResponse(genpy.Message):
  _md5sum = "631067880cb0a6bfd7be10539b2be1f3"
  _type = "knowledge_msgs/wait_for_switchResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string goal
bool command_received

"""
  __slots__ = ['goal','command_received']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(wait_for_switchResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class wait_for_switch(object):
  _type          = 'knowledge_msgs/wait_for_switch'
  _md5sum = 'de6659e2a24efa10fd97e00db2c838ff'
  _request_class  = wait_for_switchRequest
  _response_class = wait_for_switchResponse
