...
"""autogenerated by genpy from manip_msgs/InverseKinematicsFloatArrayRequest.msg. Do not edit."""
import sys
...
class InverseKinematicsFloatArrayRequest(genpy.Message):
  _md5sum = "3d9259e45801a4340eed157f58d7a2f7"
  _type = "manip_msgs/InverseKinematicsFloatArrayRequest"
...
uint32 stride  # stride of given dimension"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InverseKinematicsFloatArrayRequest, self).__init__(*args, **kwds)
...
def _get_struct_2I():
    ...
    return _struct_2I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from manip_msgs/InverseKinematicsFloatArrayResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class InverseKinematicsFloatArrayResponse(genpy.Message):
  _md5sum = "bb0ca5d8474c0440ca4189338741a555"
  _type = "manip_msgs/InverseKinematicsFloatArrayResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 y
float64 theta"""
  __slots__ = ['articular_pose','omni_base_correction']
  _slot_types = ['std_msgs/Float32MultiArray','geometry_msgs/Pose2D']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       articular_pose,omni_base_correction
    ...
    """
    if args or kwds:
      super(InverseKinematicsFloatArrayResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.articular_pose is None:
        self.articular_pose = std_msgs.msg.Float32MultiArray()
      if self.omni_base_correction is None:
        self.omni_base_correction = geometry_msgs.msg.Pose2D()
    else:
      self.articular_pose = std_msgs.msg.Float32MultiArray()
      self.omni_base_correction = geometry_msgs.msg.Pose2D()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3d().pack(_x.omni_base_correction.x, _x.omni_base_correction.y, _x.omni_base_correction.theta))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.omni_base_correction.x, _x.omni_base_correction.y, _x.omni_base_correction.theta,) = _get_struct_3d().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
def _get_struct_3d():
    ...
    return _struct_3d
class InverseKinematicsFloatArray(object):
  _type          = 'manip_msgs/InverseKinematicsFloatArray'
  _md5sum = '5286aef9c86ebe7d94286a61bc7ebe60'
  _request_class  = InverseKinematicsFloatArrayRequest
  _response_class = InverseKinematicsFloatArrayResponse
