...
"""autogenerated by genpy from navig_msgs/PlanPathRequest.msg. Do not edit."""
import sys
...
class PlanPathRequest(genpy.Message):
  _md5sum = "e328a33f1ac3d707db24f1f00f6a5f08"
  _type = "navig_msgs/PlanPathRequest"
...
float64 w
"""
  __slots__ = ['start_pose','goal_pose','start_location_id','goal_location_id']
  _slot_types = ['geometry_msgs/Pose','geometry_msgs/Pose','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start_pose,goal_pose,start_location_id,goal_location_id
    ...
    if args or kwds:
      ...
      if self.goal_location_id is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.start_location_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.goal_location_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.start_location_id = str[start:end].decode('utf-8')
      else:
        self.start_location_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal_location_id = str[start:end].decode('utf-8')
      else:
        self.goal_location_id = str[start:end]
      return self
...
def _get_struct_14d():
    ...
    return _struct_14d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from navig_msgs/PlanPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PlanPathResponse(genpy.Message):
  ...
  _type = "navig_msgs/PlanPathResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class PlanPath(object):
  _type          = 'navig_msgs/PlanPath'
  _md5sum = 'd4c7fd7dba298b47cf73caf450fd8a9f'
