...
(cl:defmethod cl:initialize-instance :after ((m <mp_getclose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_getclose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bbros_bridge-srv:<mp_getclose-request> is deprecated: use bbros_bridge-srv:mp_getclose-request instead.")))

(cl:ensure-generic-function 'location-val :lambda-list '(m))
(cl:defmethod location-val ((m <mp_getclose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bbros_bridge-srv:location-val is deprecated.  Use bbros_bridge-srv:location instead.")
  (location m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mp_getclose-request>)))
  ...
  "bbros_bridge/mp_getcloseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mp_getclose-request)))
  "Returns string type for a service object of type 'mp_getclose-request"
  "bbros_bridge/mp_getcloseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <mp_getclose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_getclose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bbros_bridge-srv:<mp_getclose-response> is deprecated: use bbros_bridge-srv:mp_getclose-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mp_getclose-response>)))
  ...
  "bbros_bridge/mp_getcloseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mp_getclose-response)))
  "Returns string type for a service object of type 'mp_getclose-response"
  "bbros_bridge/mp_getcloseResponse")
