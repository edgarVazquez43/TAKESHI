...
(cl:defmethod cl:initialize-instance :after ((m <mp_move_dist_angle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_move_dist_angle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvn_pln-srv:<mp_move_dist_angle-request> is deprecated: use mvn_pln-srv:mp_move_dist_angle-request instead.")))

(cl:ensure-generic-function 'bearing-val :lambda-list '(m))
(cl:defmethod bearing-val ((m <mp_move_dist_angle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvn_pln-srv:bearing-val is deprecated.  Use mvn_pln-srv:bearing instead.")
  (bearing m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <mp_move_dist_angle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvn_pln-srv:distance-val is deprecated.  Use mvn_pln-srv:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mp_move_dist_angle-request>)))
  ...
  "mvn_pln/mp_move_dist_angleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mp_move_dist_angle-request)))
  "Returns string type for a service object of type 'mp_move_dist_angle-request"
  "mvn_pln/mp_move_dist_angleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <mp_move_dist_angle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_move_dist_angle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvn_pln-srv:<mp_move_dist_angle-response> is deprecated: use mvn_pln-srv:mp_move_dist_angle-response instead.")))
...
(cl:defmethod traveledBearing-val ((m <mp_move_dist_angle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvn_pln-srv:traveledBearing-val is deprecated.  Use mvn_pln-srv:traveledBearing instead.")
  (traveledBearing m))
...
(cl:defmethod traveledDistance-val ((m <mp_move_dist_angle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mvn_pln-srv:traveledDistance-val is deprecated.  Use mvn_pln-srv:traveledDistance instead.")
  (traveledDistance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mp_move_dist_angle-response>)))
  ...
  "mvn_pln/mp_move_dist_angleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mp_move_dist_angle-response)))
  "Returns string type for a service object of type 'mp_move_dist_angle-response"
  "mvn_pln/mp_move_dist_angleResponse")
