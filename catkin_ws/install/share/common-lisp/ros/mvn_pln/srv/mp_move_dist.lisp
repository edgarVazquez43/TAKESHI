...
(cl:defmethod cl:initialize-instance :after ((m <mp_move_dist-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_move_dist-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvn_pln-srv:<mp_move_dist-request> is deprecated: use mvn_pln-srv:mp_move_dist-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <mp_move_dist-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mp_move_dist-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mvn_pln-srv:<mp_move_dist-response> is deprecated: use mvn_pln-srv:mp_move_dist-response instead.")))
