    ...
    if (tokens[0] == "nil" || tokens[0] == "droped") {
        ...
        if (success) {
            ...
            if (srvCltDisponible.call(srv)) {
                ...
                if(tokens[0] == "nil")
                    JustinaHRI::waitAfterSay("I can not complete your order because the object is not on the table",5000);
                ...
                else if (tokens[0] == "nil" && tokens[0] != "nobody" )
                {
                    ...
                    JustinaHRI::waitAfterSay("the object is not on the table",2000);
...
void callbackCmdHappen(const knowledge_msgs::PlanningCmdClips::ConstPtr& msg) {
    ...
    if (tokens[1] == "nil" && tokens[2] != "nobody") {
        JustinaHRI::waitAfterSay("Some one else take the object", 2500);
        JustinaHRI::waitAfterSay("Would you like something else", 4500);
        responseMsg.successful = 0;
        responseMsg.params = "obj prs fuente";
    }

    if (tokens[1] == "nil" && tokens[2] == "nobody") {
        JustinaHRI::waitAfterSay("Some one else take the obkect", 2500);
        JustinaHRI::waitAfterSay("Would you like something else", 4500);
        responseMsg.successful = 0;
        responseMsg.params = "obj prs fuente";
    }
        ...
        JustinaHRI::waitAfterSay("The object remaince on the table", 2500);
        JustinaHRI::waitAfterSay("Would you like something else", 4500);
        responseMsg.successful = 0;
        responseMsg.params = "obj prs fuente";
    }
    ...
    if (success) {
        ...
        if (srvCltWaitConfirmation.call(srv)) {
            ...
            if (srv.response.success)
                JustinaHRI::waitAfterSay("Do you want me explain the plan", 5500);
            else
                JustinaHRI::waitAfterSay("Repeate the command please", 2500);
...
void callbackCmdExplainThePlan(
    ...
    JustinaHRI::waitAfterSay("Do you want me start to execute the plan", 2500);
    ...
    if (success2) {
        ...
        if (srvCltWhatSee.call(srv3)) {
            ...
            if (srv3.response.args == "execute") {
                JustinaHRI::waitAfterSay("I will start to execute the plan", 2000);
                no_execute = false;
            } else {
                responseMsg.successful = 0;
                no_execute = true;
    ...
    if (success && no_execute) {
        ...
        JustinaHRI::waitAfterSay("Ok would you like something else", 4500);
    }
    else{
        std::cout << testPrompt << "Needed services are not available :'("
            << std::endl;
        ...
        if (param1.compare("a_question") == 0) {
            ...
            if (success) {
                success = JustinaHRI::waitAfterSay(
                        "I am waiting for the user question", 1500);
                knowledge_msgs::planning_cmd srv;
            ...
            JustinaHRI::waitAfterSay("Hellow my name is Takeshi", 1000);
            ...
            JustinaHRI::waitAfterSay("Hello my name is Takeshi", 1000);
    ...
    if (success) {
        ...
        if (srvCltWhatSee.call(srv)) {
            ...
            if (srv.response.args == "what_see_person") {
                JustinaHRI::waitAfterSay(
                        "I am looking for people in the scene", 2500);
        ...
        if (arthurCI != arthurCD && arthurCI > arthurCD && robert > 0) {
            ...
            if (arthur > 0) {
                ...
                ss << "john solo";
                JustinaHRI::waitAfterSay(
                        "john is the only person I can see", 1500);
            } else
                ss << "john nil";
        }
        ...
        if (srv.response.args == "what_see_obj") {
            ...
            JustinaHRI::waitAfterSay(
                    "I am looking for objects on the table", 2500);
            ...
            for(float headPanTurn = 1.05; ros::ok() && headPanTurn <= 1.75; headPanTurn+=0.3){
...
void callbackCmdFindObject(
    ...
    if (success) {
        ...
        if (tokens[0] == "person") {
            ...
            success = TakeshiTasks::findPerson("", -1, TakeshiTasks::STANDING, true);
            cout << "   Searching faces" << endl;
    ...
    while (ros::ok()) {
        switch (state) {
            case SM_INIT:
                if (startSignalSM) {
                    JustinaHRI::waitAfterSay(
                            "Hello my name is takeshi. I am ready.",
                            2000);
            ...
            case SM_NAVIGATE_TO_THE_LOCATION:
                ...
                JustinaHRI::waitAfterSay("I'am ready for user questions.", 3500);
