        ...
        while (ros::ok() && !success)
        {
                ...
                case SM_INIT_STATE:
                        ...
                        if(TakeshiManip::isTheHandPressed()){
                            TakeshiHRI::say("Hello, my name is Takeshi, i'm going to start the test, tell me what you want me to do");
                ...
                case SM_WAIT_FOR_COMMAND:
                    ...
                    //TakeshiHRI::loadJSGFGrammar("grammars/hsr_challenge_august.jsgf","hsr_challenge");
                    if(TakeshiHRI::waitForSpeechRecognized(lastRecoSpeech,4000)){
                        TakeshiHRI::enableSphinxMic(false);
                        nextState=SM_PARSE_RECOG;
                    }
                break;
